...
controller.MetMostrarNoHomologados = async (req, res) => {
    ...
    try{
        ...
        let query_words_exc = ''
        const words_exc = [
            'babysec', 'ladysoft', 'navidad', 'mundial', 'looney','diseño','cumple','torta','lineas','circulos','halloween','fiestas','patrias','verano','practica','ldsft','lady-soft','ultrasec','hipoal','dove','rexona','palos','dobby','cotidian','ladisoft', 'Noble', 'celeste', 'naranja'
        ]
        // const words_exc = []
