...
controller.MetActualizarStatusSellinThanos = async (usutoken, date, perid, file_update = null, req) => {
    ...
    try{
        ...
        if(file_update){
            ...
            if(process.env.ENTORNO == 'PREPRODUCTIVO'){
                path_file = 'hmlthanos/prueba/pe/tradicional/carga_archivos/Sell In Thanos/'
            }else{
